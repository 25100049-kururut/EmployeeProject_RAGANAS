...
public class Main2 {
    public static void main(String[] args) {
        ...
        h2.setEmpID(1);
        h2.setEmpName(new Name("kyum", "kyum"));
        HourlyEmployee h3 = new HourlyEmployee(1, new Name("meri", "ros"), new MyDate(3, 6, 2007), new MyDate(15, 9, 2026), 1, 1);
        ...
        p2.setEmpID(1);
        p2.setEmpName(new Name("kyum", "kyum"));
        PieceWorkerEmployee p3 = new PieceWorkerEmployee(1, new Name("meri", "ros"), new MyDate(3, 6, 2007), new MyDate(15, 9, 2026), 1, 1);
        ...
        c2.setEmpID(1);
        c2.setEmpName(new Name("kyum", "kyum"));
        CommissionEmployee c3 = new CommissionEmployee(1, new Name("meri", "ros"), new MyDate(3, 6, 2007), new MyDate(15, 9, 2026), 1);
        ...
        b2.setEmpID(1);
        b2.setEmpName(new Name("kyum", "kyum"));
        BasePlusCommissionEmployee b3 = new BasePlusCommissionEmployee(1, new Name("meri", "ros"), new MyDate(3, 6, 2007), new MyDate(15, 9, 2026), 1, 1);
